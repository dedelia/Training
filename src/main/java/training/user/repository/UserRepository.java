...
public interface UserRepository extends BaseRepository<UserEntity, Integer>, UserRepositoryCustom {
	...
	//query nu e necesar aici Spring data jpa stie sa ia numele metodei si sa-l faca
	//exemplu neericit catre posibilitatea de a scrie query in interfata fara sa necesite implementare
